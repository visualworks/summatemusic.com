    ...
    stages {
        ...
        stage("Deploy Master") {
            ...
            steps {
                ...
                sh 'aws s3 sync $WORKSPACE/ s3://$AWS_S3_BUCKET/ --exclude="*" --exclude="*.git*" --include="*.html" --include="*.css" --include="*.png" --include="*.jpg" --include="*.js" --include="*.json" --acl="public-read" --profile jenkins'
